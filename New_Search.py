    ...
    def find(self):
        ...
        while True:
            ...
            if max != current_value and max < current_value:
                ...
                self.Experimental_Setup.move_table(0, 100)
                current_value = float(self.Experimental_Setup.measure())
                self.Experimental_Setup.move_table(e, 0)
                a = float(self.Experimental_Setup.measure())
                self.Experimental_Setup.move_table(-e, f)
            ...
            print('current =',current_value, 'max =', max, 'df_x1 =',  df_x1, 'df_y1 =',df_y1, 'df_x2 =',df_x2, 'df_y2 =',df_y2, 'a =', a, 'b = ',b, 'c= ', c, 'd = ', d, 'x = ', self.Experimental_Setup.table.x, 'y = ', self.Experimental_Setup.table.y)
